...

{
	...
	theme.name = "Deep";								// Change this when making theme
	...
	theme.button_bgcolor_b = TFT_LIGHTGREY;					
	...
	theme.input_fgcolor = TFT_PURPLE;						
	theme.input_cursor_blink = 600;						// milliseconds
